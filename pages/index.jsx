...
import { NFTCard } from './api/components/nftCard';
...
const Home = () => {
  ...
  const fetchNFTs = async() => {
    ...
    const api_key = "VHaK-CNjXJduhBILtQnSHFfXW4_KuklF"
  ...
  return (
    <div className="flex flex-col items-center justify-center py-8 gap-y-3">
      <div className="flex flex-col w-full justify-center items-center gap-y-2">
        ...
        <button className="w-1/5 text-white bg-blue-400 disabled:bg-slate-500 px-4 py-2 mt-3" onClick={
          () => {
